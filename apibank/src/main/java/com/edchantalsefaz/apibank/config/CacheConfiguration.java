package com.edchantalsefaz.apibank.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("apibank");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("apibank");
        ...
        config.getMapConfigs().put("com.edchantalsefaz.apibank.domain.*", initializeDomainMapConfig(jHipsterProperties));

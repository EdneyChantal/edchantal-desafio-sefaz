package com.edchantalsefaz.apibanco.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("apibanco");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("apibanco");
        ...
        config.getMapConfigs().put("com.edchantalsefaz.apibanco.domain.*", initializeDomainMapConfig(jHipsterProperties));
